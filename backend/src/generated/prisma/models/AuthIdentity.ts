...
export type AuthIdentityWhereInput = {
  ...
  user_id?: Prisma.StringFilter<"AuthIdentity"> | string
  provider?: Prisma.EnumAuthProviderFilter<"AuthIdentity"> | $Enums.AuthProvider
  provider_user_id?: Prisma.StringFilter<"AuthIdentity"> | string
  password_hash?: Prisma.StringNullableFilter<"AuthIdentity"> | string | null
  created_at?: Prisma.DateTimeFilter<"AuthIdentity"> | Date | string
...
export type AuthIdentityWhereUniqueInput = Prisma.AtLeast<{
  id?: string
  provider_provider_user_id?: Prisma.AuthIdentityProviderProvider_user_idCompoundUniqueInput
  AND?: Prisma.AuthIdentityWhereInput | Prisma.AuthIdentityWhereInput[]
  OR?: Prisma.AuthIdentityWhereInput[]
  NOT?: Prisma.AuthIdentityWhereInput | Prisma.AuthIdentityWhereInput[]
  user_id?: Prisma.StringFilter<"AuthIdentity"> | string
...
export type AuthIdentityScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.StringWithAggregatesFilter<"AuthIdentity"> | string
  provider?: Prisma.EnumAuthProviderWithAggregatesFilter<"AuthIdentity"> | $Enums.AuthProvider
  provider_user_id?: Prisma.StringWithAggregatesFilter<"AuthIdentity"> | string
  password_hash?: Prisma.StringNullableWithAggregatesFilter<"AuthIdentity"> | string | null
  created_at?: Prisma.DateTimeWithAggregatesFilter<"AuthIdentity"> | Date | string
}
...
export type AuthIdentityCreateInput = {
  ...
  user: Prisma.UserCreateNestedOneWithoutAuth_identitiesInput
}
...
export type AuthIdentityUpdateInput = {
  ...
  user?: Prisma.UserUpdateOneRequiredWithoutAuth_identitiesNestedInput
}
...
export type AuthIdentityProviderProvider_user_idCompoundUniqueInput = {
  provider: $Enums.AuthProvider
  provider_user_id: string
}
...
export type AuthIdentityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "user_id" | "provider" | "provider_user_id" | "password_hash" | "created_at", ExtArgs["result"]["authIdentity"]>
...
export interface AuthIdentityFieldRefs {
  ...
  readonly user_id: Prisma.FieldRef<"AuthIdentity", 'String'>
  readonly provider: Prisma.FieldRef<"AuthIdentity", 'AuthProvider'>
  readonly provider_user_id: Prisma.FieldRef<"AuthIdentity", 'String'>
  readonly password_hash: Prisma.FieldRef<"AuthIdentity", 'String'>
  readonly created_at: Prisma.FieldRef<"AuthIdentity", 'DateTime'>
}
