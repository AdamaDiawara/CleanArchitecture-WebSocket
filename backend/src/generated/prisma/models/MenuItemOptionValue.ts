...
// @ts-nocheck 
/*
 * This file exports the `MenuItemOptionValue` model and its related types.
 *
...
export type GetMenuItemOptionValueAggregateType<T extends MenuItemOptionValueAggregateArgs> = {
      [P in keyof T & keyof AggregateMenuItemOptionValue]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMenuItemOptionValue[P]>
    : Prisma.GetScalarType<T[P], AggregateMenuItemOptionValue[P]>
}
...
export type GetMenuItemOptionValueGroupByPayload<T extends MenuItemOptionValueGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MenuItemOptionValueGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MenuItemOptionValueGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MenuItemOptionValueGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MenuItemOptionValueGroupByOutputType[P]>
      }
    >
  >
...
export type MenuItemOptionValueCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<MenuItemOptionValueFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface MenuItemOptionValueDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['MenuItemOptionValue'], meta: { name: 'MenuItemOptionValue' } }
  /**
   ...
   * })
  **/
  count<T extends MenuItemOptionValueCountArgs>(
    args?: Prisma.Subset<T, MenuItemOptionValueCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MenuItemOptionValueCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends MenuItemOptionValueGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, MenuItemOptionValueGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMenuItemOptionValueGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
