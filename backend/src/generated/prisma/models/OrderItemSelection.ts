...
// @ts-nocheck 
/*
 * This file exports the `OrderItemSelection` model and its related types.
 *
...
export type GetOrderItemSelectionAggregateType<T extends OrderItemSelectionAggregateArgs> = {
      [P in keyof T & keyof AggregateOrderItemSelection]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOrderItemSelection[P]>
    : Prisma.GetScalarType<T[P], AggregateOrderItemSelection[P]>
}
...
export type GetOrderItemSelectionGroupByPayload<T extends OrderItemSelectionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OrderItemSelectionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OrderItemSelectionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OrderItemSelectionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OrderItemSelectionGroupByOutputType[P]>
      }
    >
  >
...
export type OrderItemSelectionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OrderItemSelectionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OrderItemSelectionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OrderItemSelection'], meta: { name: 'OrderItemSelection' } }
  /**
   ...
   * })
  **/
  count<T extends OrderItemSelectionCountArgs>(
    args?: Prisma.Subset<T, OrderItemSelectionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OrderItemSelectionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OrderItemSelectionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OrderItemSelectionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOrderItemSelectionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
