...
export type PromoCodeAvgAggregateOutputType = {
    ...
    min_order: runtime.Decimal | null;
...
export type GetPromoCodeAggregateType<T extends PromoCodeAggregateArgs> = {
    [P in keyof T & keyof AggregatePromoCode]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregatePromoCode[P]> : Prisma.GetScalarType<T[P], AggregatePromoCode[P]>;
};
...
export type GetPromoCodeGroupByPayload<T extends PromoCodeGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PromoCodeGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof PromoCodeGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], PromoCodeGroupByOutputType[P]> : Prisma.GetScalarType<T[P], PromoCodeGroupByOutputType[P]>;
}>>;
export type PromoCodeWhereInput = {
    ...
    min_order?: Prisma.DecimalFilter<"PromoCode"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    max_uses?: Prisma.IntFilter<"PromoCode"> | number;
    uses_count?: Prisma.IntFilter<"PromoCode"> | number;
    expires_at?: Prisma.DateTimeFilter<"PromoCode"> | Date | string;
...
export type PromoCodeScalarWhereWithAggregatesInput = {
    ...
    min_order?: Prisma.DecimalWithAggregatesFilter<"PromoCode"> | runtime.Decimal | runtime.DecimalJsLike | number | string;
    max_uses?: Prisma.IntWithAggregatesFilter<"PromoCode"> | number;
    uses_count?: Prisma.IntWithAggregatesFilter<"PromoCode"> | number;
    expires_at?: Prisma.DateTimeWithAggregatesFilter<"PromoCode"> | Date | string;
};
export type PromoCodeCreateInput = {
    ...
    min_order: runtime.Decimal | runtime.DecimalJsLike | number | string;
    max_uses: number;
    uses_count: number;
    expires_at: Date | string;
    orders?: Prisma.OrderCreateNestedManyWithoutPromo_codeInput;
};
export type PromoCodeUncheckedCreateInput = {
    ...
    uses_count: number;
    expires_at: Date | string;
    orders?: Prisma.OrderUncheckedCreateNestedManyWithoutPromo_codeInput;
};
export type PromoCodeUpdateInput = {
    ...
    min_order?: Prisma.DecimalFieldUpdateOperationsInput | runtime.Decimal | runtime.DecimalJsLike | number | string;
    ...
    orders?: Prisma.OrderUpdateManyWithoutPromo_codeNestedInput;
};
export type PromoCodeUncheckedUpdateInput = {
    ...
    uses_count?: Prisma.IntFieldUpdateOperationsInput | number;
    expires_at?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string;
    orders?: Prisma.OrderUncheckedUpdateManyWithoutPromo_codeNestedInput;
};
...
export type PromoCodeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "code" | "type" | "value" | "min_order" | "max_uses" | "uses_count" | "expires_at", ExtArgs["result"]["promoCode"]>;
...
export type PromoCodeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<PromoCodeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PromoCodeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends PromoCodeCountArgs>(args?: Prisma.Subset<T, PromoCodeCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], PromoCodeCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends PromoCodeGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, PromoCodeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPromoCodeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface PromoCodeFieldRefs {
    ...
    readonly min_order: Prisma.FieldRef<"PromoCode", 'Decimal'>;
    readonly max_uses: Prisma.FieldRef<"PromoCode", 'Int'>;
    readonly uses_count: Prisma.FieldRef<"PromoCode", 'Int'>;
    readonly expires_at: Prisma.FieldRef<"PromoCode", 'DateTime'>;
}
/**
